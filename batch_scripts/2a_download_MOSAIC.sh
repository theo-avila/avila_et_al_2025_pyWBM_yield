#!/bin/bash -l
#SBATCH --job-name=download_MOSAIC
#SBATCH --output=MOSAIC%j.log
...
python /storage/home/cta5244/work/avila_et_al_2025_pyWBM_yield/2a_data_processing_soilmoisture_mosaic.py || { echo "Python script execution failed"; exit 1; }
echo "Job completed"
