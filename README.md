...
**Compounding Uncertainty in Coupled Yield Models** <br>
Theo C. Avila<sup>1*</sup>, David Lafferty<sup>2</sup>, Ryan L. Sriver<sup>3</sup><br>
...
| pyWBM | https://github.com/david0811/pyWBM | https://doi:10.26208/38c5-8206 | We use `soilMoist`|
...
```
If issues with solving dependencies, using sh scripts may help.
